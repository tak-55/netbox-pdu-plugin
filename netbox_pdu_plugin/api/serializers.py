...
class PDUOutletSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name="plugins-api:netbox_pdu_plugin-api:pduoutlet-detail")
...
class PDUInletSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name="plugins-api:netbox_pdu_plugin-api:pduinlet-detail")
    managed_pdu = ManagedPDUSerializer(nested=True)
